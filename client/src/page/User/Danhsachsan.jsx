...
const Danhsachsan = () => {
    ...
    const [sortBy, setSortBy] = useState('createdAt'); // name, price-asc, price-desc, rating
                                        ...
                                        <Col md={6} lg={4} key={field._id} className="mb-4">
                                            <Card className="field-card h-100">
                                                ...
                                                <Card.Body>
                                                    ...
                                                    <div className="field-location mb-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                                            <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
                                                        </svg>
                                                        <strong>{field.location}</strong>
                                                    </div>
                                                    <p className="text-muted small mb-3" style={{ marginLeft: '22px', marginTop: '-8px' }}>
                                                        {field.address}
                                                    </p>
